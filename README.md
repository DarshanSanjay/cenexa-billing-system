...
The current demo stores its data in application state and does not require a database. A backend/database can be added after the UI and workflow are approved.
